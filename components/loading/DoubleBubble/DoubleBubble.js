...
import style from './DoubleBubble.module.scss';
    ...
    return (
        <div className={style.spinner_container}>
            ...
            <svg width="100%" viewBox="0 0 248 247" fill="none" xmlns="http://www.w3.org/2000/svg"  >
                <g id="spinner2">
                    <g id={style.outer} style={{animationDuration:props.speed+"s"}}>
                    ...
                    <g id={style.inner} style={{animationDuration:props.speed+"s"}}>
